...
def document_fields(with_vat, files=None, вид="обычный"):
    ...
    if вид == "нда":
        ...
        отношения = g3.text_input("Сила с (дата отношений)", value="01.09.2024",
    ...
    with st.expander("Дополнительные поля документов (сроки, место, основание)"):
        ...
        оферта_отношения = c2.text_input("Отношения с (постоплата)",
                                         value="______", key=wk("оферта_отношения_с"))
